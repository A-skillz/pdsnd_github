...
<<<<<<< HEAD
    ...
    # Capture user input for city (chicago, new york city, washington).
||||||| fa8ed2f
...
<<<<<<< HEAD
    # Capture user input for month (january, february, ... , june or none)
||||||| fa8ed2f
...
<<<<<<< HEAD
    # Capture user input for day of week (monday, tuesday, ... sunday or none)
||||||| fa8ed2f
